...
(defn main-menu-template [action-callback]
  #js [
    #js {
      :label  (app-name),
      :submenu #js [
    ...
    #js {
      ...
      :submenu #js [
        #js {
          ...
          :click (fn [item focusedWindow]
            (action-callback :open focusedWindow))
        }
      ]
    }
    #js {
...
(defn set-app-menu! [action-callback]
  (let [template (main-menu-template action-callback)]
    (let [menu (build-menu template)]
